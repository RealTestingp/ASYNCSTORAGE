...
const Profile = () => {
	...
	const {
		control,
		handleSubmit,
		reset, // add reset function to reset form values when cancelling edits
		watch, // add watch function to track form values, which will help us keeping the save button disabled/enabled
	...
	// it returns an array of all form field values, and also we need to check that every values has length > 0
	// ["Jane", "Smith", "", "A12345678", "4031234567"] => it will return false
			...
			>
				...
				<View style={styles.profileCard}>
					<View style={styles.profileRow}>
						...
						<Text style={styles.profileValues}>{values.firstName}</Text>
					</View>
				...
				<View style={styles.profileCard}>
					<View style={styles.profileRow}>
						...
						<Text style={styles.profileValues}>{values.lastName}</Text>
					</View>
					<View style={styles.divider} />
				</View>
				...
				<View style={styles.profileCard}>
					<View style={styles.profileRow}>
						...
						<Text style={styles.profileValues}>{values.email}</Text>
					</View>
					<View style={styles.divider} />
				</View>
				...
				<View style={styles.profileCard}>
					<View style={styles.profileRow}>
						...
						<Text style={styles.profileValues}>{values.studentId}</Text>
					</View>
					<View style={styles.divider} />
				</View>
				...
				<View style={styles.profileCard}>
					<View style={styles.profileRow}>
						...
						<Text style={styles.profileValues}>{values.phone}</Text>
					</View>
					<View style={styles.divider} />
				</View>
	...
	return (
		<ScrollView style={styles.container} contentContainerStyle={styles.content}>
			...
			{/* Buttons for edit mod */}
			{ hasSavedData ? (
				<View style={styles.buttonRow}>
					<Pressable style={styles.cancelButton} onPress={handleCancel}>
						<Text style={styles.cancelButtonText}>Cancel</Text>
					</Pressable>
					<Pressable style={[styles.savedButton, !isFormFilled && styles.buttonDisabled]} onPress={handleSubmit(onSubmit)}>
						<Text style={styles.buttonText}>Save Profile</Text>
					</Pressable>
				</View>
			) : (
			<Pressable style={[styles.button, !isFormFilled && styles.buttonDisabled]} onPress={handleSubmit(onSubmit)} disabled={!isFormFilled}>
				<Text style={styles.buttonText}>Save Profile</Text>
			</Pressable>
			) }
